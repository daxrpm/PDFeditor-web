    ...
    return (
      <div className="w-full">
        ...
        <input
          type={type}
          className={cn(
            "flex h-11 w-full rounded-lg border-2 border-zinc-300 bg-white px-4 py-2 text-sm transition-colors",
            ...
            "dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:hover:border-zinc-600",
